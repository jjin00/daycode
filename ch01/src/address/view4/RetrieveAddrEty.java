...
public class RetrieveAddrEty {
	...
	public AddressVO retrieve(AddressVO vo) {
		...
		try {
	         ...
	         if(rs.next()) {
	        	 raVO = new AddressVO();
	        	 raVO.setId(rs.getInt("id"));
	        	 raVO.setName(rs.getString("name"));
	        	 raVO.setAddress(rs.getString("address"));
	        	 raVO.setTelephone(rs.getString("telephone"));
	        	 raVO.setGender(rs.getString("gender"));
	        	 raVO.setRelationship(rs.getString("relationship"));
	        	 raVO.setComments(rs.getString("comments"));
	        	 raVO.setRegistedate(rs.getString("registedate"));
